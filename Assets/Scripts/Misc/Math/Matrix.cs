...
public class AcroVrMatrix
{
    // NOTE: this class is actually a copy of the "AvatarMatrix" of the pedagological version of AcroVR
    ...
    public virtual AcroVrMatrix Get(int _row, int _col, int _nbRows, int _nbColums)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_nbRows, _nbColums);
    ...
    public virtual void Set(int _row, int _col, int _nbRows, int _nbCols, AcroVrMatrix _other)
    {
        for (int j = _col; j < _col + _nbCols; j++)
        {
            for (int i = _row; i < _row + _nbRows; i++)
    ...
    public AcroVrMatrix(int _nbRows, int _nbColumns)
    {
        NbRows = _nbRows;
    ...
    public AcroVrMatrix(AcroVrMatrix _other)
    {
    ...
    public AcroVrMatrix(double[,] _other)
    {
    ...
    {
        float[,] _result = new float[NbRows, NbColumns];
        for (int j = 0; j < NbColumns; j++)
        {
            for (int i = 0; i < NbRows; i++)
            {
                _result[i, j] = (float)Value[i, j];
            }
        }
        return _result;
    }
    ...
    static public AcroVrMatrix Identity(int _nbRows, int _nbCols)
    {
        AcroVrMatrix _out = new AcroVrMatrix(_nbRows, _nbCols);
    ...
    static public AcroVrMatrix Zero(int _nbRows, int _nbCols)
    {
        return new AcroVrMatrix(_nbRows, _nbCols);
    }
    ...
    static public AcroVrMatrix operator +(AcroVrMatrix _first, AcroVrMatrix _second)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_first.NbRows, _first.NbColumns);
        Add(_first, _second, ref _result);
        return _result;
    }

    static protected void Add(AcroVrMatrix _first, AcroVrMatrix _second, ref AcroVrMatrix _result)
    {
    ...
    static protected void Multiply(
        AcroVrMatrix _first, AcroVrMatrix _second, ref AcroVrMatrix _result
    )
    {
    ...
    public AcroVrMatrix Multiply(AcroVrMatrix _other)
    {
        AcroVrMatrix _result = new AcroVrMatrix(NbRows, _other.NbColumns);
        Multiply(this, _other, ref _result);
        return _result;
    }

    static public AcroVrMatrix operator *(AcroVrMatrix _matrix, double _scalar)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_matrix.NbRows, _matrix.NbColumns);
        _matrix.Multiply(_scalar, ref _result);
        return _result;
    }
    static public AcroVrMatrix operator *(double _scalar, AcroVrMatrix _matrix)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_matrix.NbRows, _matrix.NbColumns);
        _matrix.Multiply(_scalar, ref _result);
        return _result;
    }
    static public AcroVrMatrix operator *(AcroVrMatrix _matrix, int _scalar)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_matrix.NbRows, _matrix.NbColumns);
        _matrix.Multiply(_scalar, ref _result);
        return _result;
    }
    static public AcroVrMatrix operator *(int _scalar, AcroVrMatrix _matrix)
    {
        AcroVrMatrix _result = new AcroVrMatrix(_matrix.NbRows, _matrix.NbColumns);
        _matrix.Multiply(_scalar, ref _result);
        return _result;
    }
    public AcroVrMatrix Multiply(double scalar, ref AcroVrMatrix _result)
    {
        for (int j = 0; j < NbColumns; j++)
        {
            for (int i = 0; i < NbRows; i++)
    ...
    protected void Transpose(ref AcroVrMatrix _result)
    {
    ...
    public AcroVrMatrix Transpose()
    {
        AcroVrMatrix _result = new AcroVrMatrix(NbColumns, NbRows);
    ...
    public AcroVrMatrix Cholesky()
    {
        ...
        //};
        //AcroVrMatrix ExpectedResult = new AcroVrMatrix(new double[6, 6]
        //    {
        ...
        AcroVrMatrix _result = new AcroVrMatrix(_nbRowsAndCols, _nbRowsAndCols);

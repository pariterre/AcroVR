...
#define MyCompany "S2M"
#define MyAppName "AcroVR"
#define MyAppVersion "2020.10.16"
#define MyAppPublisher "S2M --- Université de Montréal"
#define MyAppExeName "AcroVR.exe"

#define MySetupDir "C:\Devel\AcroVR Dawson\Installer\AcroVR WithSoftwareAccess"
#define MySetupIcon "s2m_final.ico"

#define MyUnityBuildDir "C:\Devel\AcroVR Dawson\Build\AcroVR WithSoftwareAccess"
#define MyDataFilesDir "C:\Devel\AcroVR Dawson\DataFiles"
...
Source: "{#MyDataFilesDir}\ConditionJson\*"; DestDir: "{app}\DataFiles\ConditionJson"; Flags: ignoreversion
Source: "{#MyDataFilesDir}\SimulationJson\*"; DestDir: "{app}\DataFiles\SimulationJson"; Flags: ignoreversion
